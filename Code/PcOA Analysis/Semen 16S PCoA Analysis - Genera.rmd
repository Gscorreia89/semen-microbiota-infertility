---
title: "Semen microbiome - PcOA - Genera Level"
...
## PCoA model at Genera Level
```{r}
PhyloseqFormatMatrix <- phyloseq::phyloseq(phyloseq::otu_table(semen16s_GeneraLevel[, 4:ncol(semen16s_GeneraLevel)], taxa_are_rows = F))
